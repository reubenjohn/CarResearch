...
EXPECTED_RESULTS = [
    ListItem(vin='3GCPDBEK9PG268088', title='New 2023 Chevrolet Silverado 1500 Custom',
             ...
             production_year=2023, brand_name='Chevrolet', model_name='Silverado 1500', miles=8, city_mpg=18,
             hwy_mpg=21, wheel_drive='4 Wheel Drive', color='Gray', seller_name='Landers McLarty Chevrolet',
             seller_phone='2567156557', seller_address='4930 University Drive\nHuntsville, AL 35816', ),
    ListItem(vin='1GKS2DKL8MR113282', title='Certified 2021 GMC Yukon Denali w/ Denali Premium Package',
             ...
             production_year=2021, brand_name='GMC', model_name='Yukon', miles=31440, city_mpg=14, hwy_mpg=19,
             wheel_drive='4 Wheel Drive', color='Black', seller_name='Paul Sur Buick GMC', seller_phone='2193862790',
    ...
    ListItem(vin='2GNAXKEV9L6177665', title='Certified 2020 Chevrolet Equinox LT',
             ...
             hwy_mpg=None, wheel_drive='2 wheel drive - front', color='Brown',
             seller_name='Serpentini Chevrolet Willoughby Hills', seller_phone='8335950340',
             seller_address='2810 BISHOP RD\nWilloughby Hills, OH 44092', ),
    ListItem(vin='1G1ZD5ST1MF032404', title='Used 2021 Chevrolet Malibu LT',
             listing_url='https://www.kbb.com/cars-for-sale/vehicledetails.xhtml?listingId=681902564',
             image_url='https://atcimages.kbb.com/hn/c/a806fed96eff4c809fcd84cc9a15805c.jpg', price_usd=22941,
             production_year=2021, brand_name='Chevrolet', model_name='Malibu', miles=63326, city_mpg=29, hwy_mpg=36,
             wheel_drive='2 Wheel Drive - Front', color='Silver', seller_name='Andy Mohr Speedway Chevrolet Inc',
             seller_phone='3176614599', seller_address='5252 W 38th Street\nIndianapolis, IN 46254', ),
    ...
    ListItem(vin='1G1ZD5ST4NF205107', title='Used 2022 Chevrolet Malibu LT',
             listing_url='https://www.kbb.com/cars-for-sale/vehicledetails.xhtml?listingId=686830354',
             image_url='//atcimages.kbb.com/hn/c/173d1d1ac7514732aa19b8b574cd089f.jpg', price_usd=26749,
             production_year=2022, brand_name='Chevrolet', model_name='Malibu', miles=2688, city_mpg=None, hwy_mpg=None,
             wheel_drive='2 wheel drive - front', color='Gray', seller_name='Chevrolet GMC of Mount Vernon',
             seller_phone='7404627222', seller_address='510 HARCOURT RD\nMount Vernon, OH 43050', ),
    ...
    ListItem(vin='1C4RJEAG2LC393077', title='Used 2020 Jeep Grand Cherokee Laredo',
             ...
             hwy_mpg=None, wheel_drive='2 wheel drive - rear', color='Black', seller_name='Cavender Cadillac',
    ...
    ListItem(vin='KL79MSSL2MB121571', title='Certified 2021 Chevrolet TrailBlazer ACTIV w/ Sun and Liftgate Package',
             ...
             hwy_mpg=None, wheel_drive='All wheel drive', color='Black', seller_name='Hugh White Chevrolet Buick',
    ...
    ListItem(vin='1N6ED1EJ0NN671189', title='Used 2022 Nissan Frontier SV',
             listing_url='https://www.kbb.com/cars-for-sale/vehicledetails.xhtml?listingId=686925414',
             image_url='//atcimages.kbb.com/hn/c/7b51696df7eb4cdca9723563849549df.jpg', price_usd=33490,
             production_year=2022, brand_name='Nissan', model_name='Frontier', miles=5323, city_mpg=None, hwy_mpg=None,
             wheel_drive='2 wheel drive - rear', color='Black', seller_name='Cavender Nissan of Rockwall',
             seller_phone='9729612319', seller_address='1700 E INTERSTATE 30\nRockwall, TX 75087', ),
    ...
    ListItem(vin='5FNYF5H69LB002990', title='Used 2020 Honda Pilot Touring',
             listing_url='https://www.kbb.com/cars-for-sale/vehicledetails.xhtml?listingId=687011703',
             image_url='//atcimages.kbb.com/hn/c/fcd30da58f434be9b14dcb2a30c3cfde.jpg', price_usd=34228,
             production_year=2020, brand_name='Honda', model_name='Pilot', miles=36472, city_mpg=None, hwy_mpg=None,
             wheel_drive='2 wheel drive - front', color='Black', seller_name='Norm Reeves Honda Superstore West Covina',
             seller_phone='6265419088', seller_address='1840 East Garvey Avenue South\nWest Covina, CA 91791', ),
    ...
    ListItem(vin='1C4RJFCG1LC363667', title='Used 2020 Jeep Grand Cherokee Overland',
             ...
             hwy_mpg=None, wheel_drive='4 wheel drive', color='Black', seller_name='Auto Outlets of Webster',
    ...
    ListItem(vin='JTEHU5JR0M5867937', title='Used 2021 Toyota 4Runner Venture',
             listing_url='https://www.kbb.com/cars-for-sale/vehicledetails.xhtml?listingId=686813576',
             image_url='//atcimages.kbb.com/hn/c/abcafcb1a5ad401bac4f433c7fe31bf4.jpg', price_usd=47500,
             production_year=2021, brand_name='Toyota', model_name='4Runner', miles=12455, city_mpg=None, hwy_mpg=None,
             wheel_drive='4 wheel drive', color='Red', seller_name='Automaxx of the Carolinas',
             seller_phone='8434800045', seller_address='1016 North Main Street\nSummerville, SC 29483', ),
